        ...
        super(Slash.of("downloads", "Manage downloads")
                ...
                .group(Group.of("download", "Manage downloads")
                        .subCommand(SubCommand.of("create", "Create a download")
                                ...
                                .argument(Argument.text("repository", "Group id of download").asRequired().withAutoComplete())
                                .argument(Argument.text("group_id", "Group id of download").asRequired().withAutoComplete())
                                .argument(Argument.text("artifact_id", "Group id of download").asRequired().withAutoComplete())
                        ...
                        .subCommand(SubCommand.of("edit", "Edit a download")
                                ...
                                .argument(Argument.text("product", "Product name").withAutoComplete().asRequired())
                                .argument(Argument.text("type", "Download type").withAutoComplete().asRequired())
                                .argument(Argument.text("repository", "Group id of download").withAutoComplete())
                                .argument(Argument.text("group_id", "Group id of download").withAutoComplete())
                                .argument(Argument.text("artifact_id", "Group id of download").withAutoComplete())
                                .argument(Argument.text("classifier", "Group id of download"))
                        )
